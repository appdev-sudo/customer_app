...
const getDefaultBaseUrl = () => {
  if (__DEV__) {
    ...
    return 'https://a85e-2409-40c0-1066-d22f-a997-2bbb-f874-3f1d.ngrok-free.app';
  }
  return 'https://a85e-2409-40c0-1066-d22f-a997-2bbb-f874-3f1d.ngrok-free.app'; // replace with production API URL
};
